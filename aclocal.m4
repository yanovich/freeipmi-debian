...
m4_include([config/ac_freeipmi_interpret_sensor_config_file.m4])
m4_include([config/ac_ipmi_monitoring_sdr_cache_dir.m4])
m4_include([config/ac_ipmi_monitoring_sensor_config_file.m4])
m4_include([config/ac_ipmiconsole_config_file.m4])
